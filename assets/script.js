...
function showResult(){
  ...
  document.getElementById('res-cta-link').href=`https://www.contate.me/258862578089111?text=${waMsg}`;
  document.querySelector('.wa-float').href=`https://www.contate.me/258862578089111?text=${waMsg}`;
