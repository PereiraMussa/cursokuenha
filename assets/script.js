...
function showResult(){
  ...
  document.getElementById('res-cta-link').href=`https://www.contate.me/258833928376?text=${waMsg}`;
  document.querySelector('.wa-float').href=`https://www.contate.me/258833928376?text=${waMsg}`;
